...
const Switch = (
  { name, value, checked, onChange, ...props }: UseSwitchParameters & HTMLProps<HTMLInputElement>,
) => {
  const { getInputProps, disabled, focusVisible } = useSwitch({ ...props, checked, onChange });
